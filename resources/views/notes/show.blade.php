    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex">
                ...
                @method('delete')
                @csrf
                <button type="submit" class="btn btn-danger ml-4" onclick="return confirm('are you sure you want to move this note to trush?')">Move to Trash</button>
          ...
          <button type="submit" class="btn-link " >Restore Note</a>
            ...
            @method('delete')
            @csrf
            <button type="submit" class="btn btn-danger ml-4" onclick="return confirm('are you sure you want to delete this note permanently?This action cannot be undone!')">Erase</button>
